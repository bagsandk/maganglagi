...
<div class="main main-raised">
	<div class="container">
		<div class="section text-center">
			<?php echo form_open_multipart('user/add', array("role" => "form")); ?>
			<div class="form-group">
				<div class="input-group input-group-merge input-group-alternative mb-3">
					<div class="input-group-prepend">
						<span class="input-group-text"><i class="material-icons">face</i></span>
					</div>
					<input style="text-transform: capitalize;" class="form-control" placeholder="Display name" type="text" name="name">
					...
					<div class="input-group input-group-merge input-group-alternative  mt-3">
						...
						<select name="active" class="form-control">
							...
							foreach ($active as $i => $p) {
								$selected = ($i == $this->input->post('active')) ? ' selected="selected"' : "";
				...
				<div class="form-group col-md-6">
					<div class="input-group input-group-merge input-group-alternative mt-3">
						...
						<select name="role" class="form-control">
							...
							foreach ($role as $i => $p) {
								$selected = ($i == $this->input->post('role')) ? ' selected="selected"' : "";
								echo '<option value="' . $i . '"' . $selected . '>' . $p . '</option>';
							}
							?>
						</select>
